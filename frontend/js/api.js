...
// Backend base URL. Falls back to same-origin (/api) when the frontend
// is served by the backend itself. Set window.APP_API_BASE_URL in
// js/config.js to point at a separately-hosted backend.
const BASE_URL = (window.APP_API_BASE_URL || '/api').replace(/\/+$/, '');
